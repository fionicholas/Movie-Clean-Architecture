...
void main() {
  ...
  group('get Now Playing Tv Shows', () {
    final tvShowList = TvShowResponse.fromJson(
  ...
  group('get tv show detail', () {
    final tId = 1;
    final tvShowDetail = TvShowDetailModel.fromJson(
  ...
  group('search tv shows', () {
    final tSearchResult = TvShowResponse.fromJson(
            json.decode(readJson('dummy_data/search_spiderman_tv_show.json')))
        .tvShowList;
    ...
    test('should return list of tv shows when response code is 200', () async {
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/search_spiderman_tv_show.json'), 200));
      // act
